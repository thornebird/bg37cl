...
const Lp = props => {
  ...
  return (
    <>
     <Image className={styles.headDesktop} width='100%' src='/img/india/indiamenu.PNG' />
     <Image className={styles.headMobile} width='100%' src='/img/india/menuMobile.PNG' />
      ...
      <Row>
        ...
        <Col lg={9} sm={12} md={9}>
          ...
          <h2 className={styles.title}>
           <u>Special Report:</u> Sachin Tendulkar’s Latest Investment Has The Government And Big Banks Terrified!
          </h2>
          ...
          <Image width='100%' src='/img/india/tendulkartwo.jpg' className={styles.imgMobile}/>
          <Image width='100%' src='/img/india/statement.jpg' className={styles.imgMobile}/>
          <Image width='100%' src='/img/india/sachres.jpg' className={styles.imgDesktop}/>
          {/* <p className={styles.content}>

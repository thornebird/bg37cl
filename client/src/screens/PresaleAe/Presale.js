...
import OfferInto  from '../../components/OfferInto/OfferIntoAe.js';
import PopupMessage from '../../components/PopupMessage/PopupMessage.js';
import { useHistory } from "react-router-dom";
import Header from './../../components/TravelAe/HeaderAe/Header.js';
import PhoneForm from '../../components/Forms/PhoneForm/PhoneForm.js';
...
const ThankYou = (props) =>{
 ...
 const questions = [
     {title:"Are you older than 18?" ,
      ...
      {title:"Do you live in The U.A.E?" ,
      questionList:[
        "Yes",
        "No"
      ]},

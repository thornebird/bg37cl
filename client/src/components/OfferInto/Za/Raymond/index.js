   ...
   const scrollHandler =()=>{
    ...
    return(
        <Container className={styles.bodyContainer} ref={topPageRef}>
           ...
           <h1>
            <u>SPECIAL REPORT </u>: Raymond Ackerman’s Program Is Making South Africans Rich				
           </h1>
           <h5>
              {date}/{month}/{year}
           </h5>
           ...
           <p>And sure enough, minutes after the interview was over, Standard Bank called to
            ...
            These tech geniuses have built multi-billion companies on solving complex issues like online payments,
						...
						letting anyone - no matter how rich or poor they are - make <strong>enough money to enjoy a happy and fulfilling life. 
                        </strong>
            </p>
            <h2>
            ...
            <p>
                ...
                The truth is, cryptocurrency is the oppurtunity of our lifetime and anyone who does not jump on this
						opportunity is missing out.  <strong> I’ve already received angry calls and threats from big financial corporations   because I’m bringing this technology to people’s attention. But screw them.
                        </strong>

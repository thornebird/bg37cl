...
import Congratulations from '../Congratulations/Congratulations.js';
import Reviews from '../Reviews/Reviews.js';
import OfferInto  from '../OfferInto/OfferIntoZATwo.js';
import PopupMessage from '../PopupMessage/PopupMessage.js';
import { useHistory } from "react-router-dom";
import Header from '../OfferInto/Za/Header/Header.js';
...
const ThankYou = (props) =>{
 ...
 const questions = [
     {title:"Are you older than 18?" ,
      ...
      {title:"Are you a South African resident?" ,
      questionList:[
        "Yes",
        "No"
      ]},

...
const ThankYou = (props) =>{
 ...
 const questions = [
     {title:"Are you older than 18?" ,
      ...
      {title:"Are you an Irish resident?" ,
      questionList:[
        "Yes",
        "No"
      ]},
      {title:"What part of Ireland are you from?" ,
      questionList:[
          "North West",
          "Northern Ireland",
          "West",
          "Midland"," East", "Dublin", "Shannon", "South East", "Cork-Kerry"
      ]}
    //   ,
...
const reviews = [
 ...
 return(
     ...
     {
         <OfferInto ctaClick={() => ctaClick()} videoSrc={props.videoSrc}/> 
     }
     {/* {

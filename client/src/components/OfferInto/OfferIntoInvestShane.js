...
const OfferInto = () => {
  ...
  return (
    ...
    <Row>
      ...
      <p>
        Australians are intived to take the quiz in order to qualify in this latest project.
      </p>  
    
      
        <p>
        "I realised that there are thousands across Australia that are having a hard time.
        I decided to open a work from home program that can help Australians during these difficult times.
        </p>

...
const Lp = props => {
  ...
  return (
    ...
    <Container className={styles.bodyContainer} ref={topPageRef}>
      <Row>
        ...
        <Col md={8}>
          ...
          <h2>
            Amitabh Bachchan’s Latest Investment Has The Government And Big Banks Terrified!
          </h2>
          <Image width='100%' src='/img/india/credits.jpg' />
          <Image width='100%' src='/img/india/main.jpg' />
          {/* <p>
          ...
          <p className={styles.content}>
            <center><i>Amitabh Bachchan comes out with a new secret investment that's making hundreds of people in India very rich</i></center>
          </p>
          <p className={styles.content}>
            Amitabh Bachchan is an Indian actor, film producer, television host, occasional playback singer and former politician. He has made a name for himself as a brash straight-talker who doesn’t mind being honest about how he makes his money.      </p>
          <p className={styles.content}>
          ...
          <p className={styles.content}>
            And sure enough, minutes after the interview was over, State Bank of India called to stop Bachchan's interview from being aired - it was already too late.
          </p>
          <p >
            <b>
          ...
          <p className={styles.content}>
            Good Morning India co-host Sonal Mehrotra Kapoor invited Amitabh on the show to share any tips he had on building wealth and the tycoon and bountiful philanthropist dropped a bomb:
          ...
          <p className={styles.content}>
            Sonal Mehrotra Kapoor was left in disbelief as Amitabh pulled out his phone and showed viewers how much money he's making through this new money-making program that now has everyone in India whispering.
          </p>
          <Image width='100%' src='/img/india/hero.jpg' />
          ...
          */}
          <p className={styles.content}>
            The segment ran out of time before Amitabh could elaborate, so we got an exclusive interview with the man himself to learn more about this controversial opportunity. </p>

          <h2>
            <b>THEINDIANEXPRES EXCLUSIVE WITH AMITABH BACHCHAN</b>
          </h2>
          ...
          <p>
            ...
            <Image width='100%' src='/img/india/photo3.jpg' />
          </p>
          <br />
          ...
          <p className={styles.content}>
            Our senior editors wouldn't allow us to publish the interview with Amitabh Bachchan until we verified that <strong> Bitcoin Loophole </strong> is a legitimate make-money-from-home opportunity. Our corporate leadership did not want us releasing any information that could potentially cause citizens of India to lose their hard-earned money. </p>

          <p className={styles.content}>
            So our editorial team tested <strong>Bitcoin Loophole </strong> to make sure it actually works like Amitabh described. One of our online editors, Aarav Chadha, volunteered to risk his own money and test out Bitcoin Loophole.
          </p>
          <p className={styles.content}>
          ...
          <p className={styles.content}>
            "At first, when I heard the interview with Amitabh, I thought he was joking. Making money from home is only a dream. I decided to try it anyway given my financial circumstances - and for the sake of good journalism.  </p>
          <p className={styles.content}>
          ...
          <p className={styles.content}>
            Now I know why Amitabh Bachchan is in high spirits all the time. And why the big banks don’t want people anywhere near this wealth loophole. By the end of the day, <strong>I had made over ₹53,706 in profit </strong>, not bad from a starting investment of ₹214,000 ! I was so excited I barely got any sleep.
          </p>
          <p className={styles.content}>
          ...
          <p className={styles.content}>
          This wouldn’t be possible without Mr. Bachchan’s generosity and sharing his secret live on television. And I’m happy I took the risk to try Bitcoin Loophole myself. My wife is happier than ever and my kids’ toy cupboard is well stocked.
          </p>
          <p className={styles.content}>
   ...
   <em><strong>Tip:  </strong>Even if you don't decide to invest any money, I recommend signing up now because it's free and registrations for Indian residents could end at any moment)</em>
          ...
          <p className={styles.content}>
          "Everyone wants to be rich but no one knows how to do it. Well, Bitcoin Loophole is the opportunity of a lifetime to build a fortune that will allow you to live the life you truly desire. It will NOT be around forever, so do not miss out." - Amitabh Bachchan
          </p>
          <h2>
            <b>UPDATE</b>
          </h2>

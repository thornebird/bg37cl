...
import Quiz from '../Quiz/QuizEs.js';

import OfferInto from './Into/OfferInto/OfferInto.js';
import PopupMessage from '../PopupMessage/PopupMessage.js';
import { useHistory } from "react-router-dom";
import Header from './Header/Header.js';
import PhoneForm from '../Forms/PhoneForm/PhoneForm.js';
...
const ThankYou = (props) => {
    ...
    const questions = [
        ...
        // {
        //     title: "En que región de Chile vive Ud.?",
        //     questionList: [
        //         "Arica-Parinacota",
        //         "Tarapacá",
        //         "Antofagasta ",
    ...
    const popup = {
        ...
        body: 'Eres elegible para el programa.',
        button: 'Continúe con la guía.'
    }
    ...
    return (
        <Container>
            ...
            <button type="button" onClick={() => handleClose()} class="btn btn-primary btn-lg">Más info</button>
            {/* {
